...
- It retains the v1.2 fixed model interfaces, scheduled simplification, and verification workspace.
- It adds the trouble intervention after more than 50 additional actions on a failed level and uses the accelerated client.
