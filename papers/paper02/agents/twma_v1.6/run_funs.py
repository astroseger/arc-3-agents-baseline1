...
SERVER_IMAGE = "game-server-sequence-no-executable-v1-6"
AGENT_IMAGE = "codex-agent-sequence-no-executable-v1-6"
PROXY_IMAGE = "openai-proxy-sequence-no-executable-v1-6"
SERVER_PORT = 8879
PROXY_PORT = 3128
