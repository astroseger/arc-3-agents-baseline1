...
SERVER_IMAGE = "game-server_sequence-no-executable-v1.2"
AGENT_IMAGE = "codex-agent_sequence-no-executable-v1.2"
PROXY_IMAGE = "openai-proxy_sequence-no-executable-v1.2"
SERVER_PORT = 8879
PROXY_PORT = 3128
