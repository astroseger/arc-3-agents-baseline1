...
SERVER_IMAGE = "game-server-sequence-no-exactly-ws-v-1-2"
AGENT_IMAGE = "codex-agent-sequence-no-exactly-ws-v-1-2"
PROXY_IMAGE = "openai-proxy-sequence-no-exactly-ws-v-1-2"
SERVER_PORT = 8879
PROXY_PORT = 3128
